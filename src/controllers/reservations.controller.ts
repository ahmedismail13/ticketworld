...
class ReservationsController {
  ...
  public getAllReservations = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      const allReservations = await this.reservationService.findAllReservations(req.user);
  ...
  public createReservation = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      ...
      const reservation: Reservation = await this.reservationService.createReservation(
        req.user,
